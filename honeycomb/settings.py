...
PREVIEW_URL = (
    rf"https://discover.agrc.utah.gov/login/path/{QUAD_WORD}/tiles/preview#basemap_{{}}_test/8/39.527/-111.555"
)
...
CACHE_EXTENTS = [[EXTENT_0_7, SCALES[0:8]], [EXTENT_8_9, SCALES[8:10]], [EXTENT_10_14, SCALES[10:15]]]
