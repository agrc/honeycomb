...
print(f'building cache for scales from {min_cached_scale} to {max_cached_scale}')
...
arcpy.management.ManageTileCache(str(cache_directory), manage_mode='RECREATE_EMPTY_TILES',
    in_cache_name=f'{map}_compact', in_datasource=pro_map, tiling_scheme='ARCGISONLINE_SCHEME',
    area_of_interest=str(project_extent), min_cached_scale=min_cached_scale, max_cached_scale=max_cached_scale)
